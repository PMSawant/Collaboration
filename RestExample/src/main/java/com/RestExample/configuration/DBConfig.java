...
public class DBConfig {
	...
	public SessionFactory sessionFactory() {
		...
		return lsf.addAnnotatedClass(Friend.class).addAnnotatedClass(Forum.class).addAnnotatedClass(Blog.class).addAnnotatedClass(Person.class).buildSessionFactory();
	}
	@Bean
